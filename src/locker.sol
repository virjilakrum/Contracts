...
pragma solidity 0.6.12; //sürüm değişecek
    ...
    GlobalAccessControlManaged
{
    ...
    //token constants
    IERC20Upgradeable public stakingToken; // AP token
